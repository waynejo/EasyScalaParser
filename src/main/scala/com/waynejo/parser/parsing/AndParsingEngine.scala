    ...
    def parse[A](text: String, terminals: List[TerminalParsingElement]): PartialFunction[ParsingElement[A], Either[ParsingFailInfo, ParsingSuccessInfo[A]]] = {
        ...
        case AndParsingElement4(pe0, pe1, pe2, pe3, reducer, _) =>
            for {
                ...
                r1 <- ParsingEngine._parse(pe1, r0.remain, Nil)
                r2 <- ParsingEngine._parse(pe2, r1.remain, Nil)
                r3 <- ParsingEngine._parse(pe3, r2.remain, Nil)
        ...
        case AndParsingElement5(pe0, pe1, pe2, pe3, pe4, reducer, _) =>
            for {
                ...
                r2 <- ParsingEngine._parse(pe2, r1.remain, Nil)
                r3 <- ParsingEngine._parse(pe3, r2.remain, Nil)
                r4 <- ParsingEngine._parse(pe4, r3.remain, Nil)
        ...
        case AndParsingElement6(pe0, pe1, pe2, pe3, pe4, pe5, reducer, _) =>
            for {
                ...
                r3 <- ParsingEngine._parse(pe3, r2.remain, Nil)
                r4 <- ParsingEngine._parse(pe4, r3.remain, Nil)
                r5 <- ParsingEngine._parse(pe5, r4.remain, Nil)
        ...
        case AndParsingElement7(pe0, pe1, pe2, pe3, pe4, pe5, pe6, reducer, _) =>
            for {
                ...
                r4 <- ParsingEngine._parse(pe4, r3.remain, Nil)
                r5 <- ParsingEngine._parse(pe5, r4.remain, Nil)
                r6 <- ParsingEngine._parse(pe6, r5.remain, Nil)
        ...
        case AndParsingElement8(pe0, pe1, pe2, pe3, pe4, pe5, pe6, pe7, reducer, _) =>
            for {
                ...
                r5 <- ParsingEngine._parse(pe5, r4.remain, Nil)
                r6 <- ParsingEngine._parse(pe6, r5.remain, Nil)
                r7 <- ParsingEngine._parse(pe7, r6.remain, Nil)
        ...
        case AndParsingElement9(pe0, pe1, pe2, pe3, pe4, pe5, pe6, pe7, pe8, reducer, _) =>
            for {
                ...
                r6 <- ParsingEngine._parse(pe6, r5.remain, Nil)
                r7 <- ParsingEngine._parse(pe7, r6.remain, Nil)
                r8 <- ParsingEngine._parse(pe8, r7.remain, Nil)
        ...
        case AndParsingElement10(pe0, pe1, pe2, pe3, pe4, pe5, pe6, pe7, pe8, pe9, reducer, _) =>
            for {
                ...
                r7 <- ParsingEngine._parse(pe7, r6.remain, Nil)
                r8 <- ParsingEngine._parse(pe8, r7.remain, Nil)
                r9 <- ParsingEngine._parse(pe9, r8.remain, Nil)
