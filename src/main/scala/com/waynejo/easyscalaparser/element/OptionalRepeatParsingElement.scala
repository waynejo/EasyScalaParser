...
case class OptionalRepeatParsingElement[A](parsingElement: ParsingElement[A], reducer: (A, A) => A, override val id: Int = 0, override val srcId: Int = 0) extends ParsingElement[A] {
  def name: String = {
    ""
  }
